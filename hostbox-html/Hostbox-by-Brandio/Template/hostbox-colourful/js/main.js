...
$(window).on("load", function() {
	...
	function openBox(){
			...
			setTimeout(function(){
				$(".feature3","#features").removeClass("inside-box-left");
			}, 600);
			setTimeout(function(){
				$(".feature4","#features").removeClass("inside-box-left");
			}, 700);
            setTimeout(function(){
				$(".feature5","#features").removeClass("inside-box-right");
			}, 400);
            setTimeout(function(){
				$(".feature6","#features").removeClass("inside-box-right");
			}, 500);
            setTimeout(function(){
				$(".feature7","#features").removeClass("inside-box-right");
			}, 600);
            setTimeout(function(){
				$(".feature8","#features").removeClass("inside-box-right");
			}, 700);
	...
	function closeBox(){
            ...
            $(".feature3","#features").addClass("inside-box-left");
			$(".feature4","#features").addClass("inside-box-left");
			$(".feature5","#features").addClass("inside-box-right");
			$(".feature6","#features").addClass("inside-box-right");
            $(".feature7","#features").addClass("inside-box-right");
            $(".feature8","#features").addClass("inside-box-right");
